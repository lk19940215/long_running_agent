// ============================================================================
// 📁 文件：AppState.tsx
// 📌 定位：AppState 的 React 集成层
// 🔗 调用链：AppStateProvider 包裹应用树；useAppState / useSetAppState / useAppStateStore 供组件订阅与更新
//
// 核心概念：
//   - AppStateProvider + useAppState/useSetAppState/useAppStateStore hooks，使用 React 18 的 useSyncExternalStore 实现精确订阅
