// ============================================================================
// 📁 文件：QueryEngine.ts
// 📌 定位：会话级查询引擎，管理整个多轮对话的生命周期
//
// 🔗 调用链：REPL.tsx → onQuery → QueryEngine.submitMessage → query.ts
//
// 核心概念：
//   - submitMessage() 以 async generator 编排单轮查询
//   - 维护 messages[]、AbortController、permissionDenials、usageTracker
//   - ask()：组装 systemPrompt + userContext + systemContext → query()
//   - skill discovery、文件状态跟踪、续写恢复
//
