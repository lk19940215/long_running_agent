// ============================================================================
// 📁 文件：Tool.ts
// 📌 定位：所有工具的"契约"——Tool 接口定义 + buildTool() 工厂
// 🔗 调用链：buildTool → 各具体工具实现；tools.ts 聚合；toolExecution / StreamingToolExecutor 运行时调用
//
// 核心概念：
//   - Tool 接口：call / prompt / checkPermissions / inputSchema / isReadOnly / isConcurrencySafe
//   - buildTool()：TOOL_DEFAULTS 安全默认值 + 用户定义覆盖 = fail-closed 设计
//   - ToolUseContext：工具执行时的上下文（options, abortController, readFileState, messages 等）
// 详细文档：→ 源码阅读/04-工具系统.md
// ============================================================================
