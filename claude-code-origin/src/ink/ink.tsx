// ============================================================================
// 📁 文件：ink.tsx
// 📌 定位：Ink 终端渲染引擎主入口——生命周期 + 渲染调度 + 事件处理
//
// 核心概念：
//   - Ink 类：FiberRoot + DOMElement + Renderer + Terminal + 双缓冲 Frame
//   - scheduleRender：throttle ~16ms 渲染节流
//   - actualRender：Yoga 布局 → Output → Screen → Terminal diff
//   - 事件：键盘/鼠标/选择/Alt Screen
// 详细文档：→ 源码阅读/10-Ink-UI.md
// ============================================================================
